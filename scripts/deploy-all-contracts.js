...
async function main() {
  console.log("🚀 Starting Complete Mazunte Smart Contract Deployment...\n");
  ...
  console.log("✅ Secondary Marketplace deployed to:", await marketplace.getAddress());
  ...
  console.log("   Secondary Marketplace:", await marketplace.getAddress());
  console.log("\n🌐 Network Information:");
  console.log("   Network:", network.name);
  console.log("   Chain ID:", network.config.chainId);
  console.log("   Explorer:", getExplorerUrl(network.config.chainId));
  console.log("\n💡 Next Steps:");
  console.log("   1. Run verification script: npm run verify:fuji");
  ...
  // Log the addresses for easy copy-paste
  console.log("\n📝 Copy these addresses to your frontend:");
  console.log("USDT:", await usdt.getAddress());
  console.log("MAZUNTE_MORTGAGE:", await mortgage.getAddress());
  console.log("VILLAGE_CITIZENSHIP:", await citizenship.getAddress());
  console.log("SECONDARY_MARKETPLACE:", await marketplace.getAddress());
}
