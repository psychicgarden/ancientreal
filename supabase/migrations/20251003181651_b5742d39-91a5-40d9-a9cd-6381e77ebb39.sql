-- Fix apply_mortgage_payment to not update generated column remaining_balance_base
-- and rely on principal_paid_base changes to derive base remaining balance
...
BEGIN
  ...
  -- Primary update by user_address (do NOT update remaining_balance_base since it's generated)
  ...
  SET 
    ...
    -- keep numeric remaining_balance in sync for UI (base value will auto-derive)
