-- Step A: Clean up the RPC function (corrected approach)

-- 1. Drop all existing versions of apply_mortgage_payment function
DROP FUNCTION IF EXISTS public.apply_mortgage_payment(text, integer, bigint, bigint, text);
