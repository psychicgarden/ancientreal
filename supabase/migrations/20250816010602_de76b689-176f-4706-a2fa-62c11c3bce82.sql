-- First, create all archive tables outside of the function
...
-- Drop and recreate the function without table creation logic
...
begin
  ...
  -- Archive then delete investor_rental_claims
  ...
  -- Archive then delete secondary_orders
  ...
  -- Archive then delete secondary_trades
  ...
  -- Archive then delete fractional_investments
  ...
  -- Archive and delete user_properties (tables already exist)
  ...
  -- Archive and delete user_transactions (tables already exist)
  ...
  -- Archive and delete platform_fees (tables already exist)
  ...
  -- Recompute tokens_sold for affected properties
