              ...
              <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    ...
                    { title: "Platform & Tech", amount: "$0.25M", desc: "Core mortgage engine + secondary marketplace. $50K ring-fenced for audits." },
                    { title: "Marketing & Brand", amount: "$0.40M", desc: "$200K GTM/partnerships. $200K brand + storytelling." },
