            ...
            <TabsContent value="budget-breakdown" className="space-y-8">
              ...
              <Card className="p-8 bg-gradient-card border-none shadow-luxury">
                <div className="space-y-8">
                  ...
                  {/* Treasury Ledger - Soho House Inspired Design */}
                  <div className="space-y-8">
                    <div className="text-center space-y-4">
                      <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-slate-900 to-slate-800 dark:from-slate-800 dark:to-slate-700 px-6 py-3 rounded-full">
                        ...
                        <h4 className="text-xl font-bold text-white">The Treasury Ledger</h4>
                        <div className="text-amber-400 text-sm font-medium">Key Milestones</div>
                      </div>
                    </div>

                    {/* Sophisticated Card-Based Layout */}
                    <div className="space-y-6">
                      {/* Initial Investment - Hero Card */}
                      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-800 dark:via-slate-700 dark:to-slate-800 rounded-2xl p-8 border border-amber-200/20 shadow-2xl">
                        ...
                        <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
                          <div className="lg:col-span-1">
                            <div className="text-amber-400 text-sm font-medium uppercase tracking-wider">Start</div>
                          </div>
                          <div className="lg:col-span-2">
                            <h5 className="text-xl font-bold text-white mb-1">Initial Investment</h5>
                            <p className="text-slate-400 text-sm">Foundation capital deployed</p>
                          </div>
                          ...
                          <div className="lg:col-span-1 text-right">
                            <div className="text-amber-400 text-sm font-medium">Treasury Balance</div>
                            <div className="text-3xl font-bold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">$7.00M</div>
                            <div className="text-emerald-400 text-sm font-medium">$0.00M at risk</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid gap-4">
                        {/* Phase 1 */}
                        <div className="bg-gradient-to-r from-slate-50 to-white dark:from-slate-900/50 dark:to-slate-800/50 rounded-xl p-6 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 items-center">
                            <div className="lg:col-span-1">
                              <div className="inline-flex items-center space-x-2 bg-slate-900 dark:bg-slate-700 px-3 py-1 rounded-full">
                                <div className="w-2 h-2 bg-amber-400 rounded-full"></div>
                                <span className="text-white text-sm font-medium">M1-M11</span>
                              </div>
                            </div>
                            <div className="lg:col-span-2">
                              <h5 className="font-bold text-slate-900 dark:text-slate-100 mb-1">Legal, Platform, Mexico Setup</h5>
                              <p className="text-slate-600 dark:text-slate-400 text-sm">Infrastructure & foundation build</p>
                            </div>
                            <div className="lg:col-span-1 text-center">
                              <div className="text-red-500 text-xl font-bold">-$1.21M</div>
                              <div className="text-slate-500 text-xs">Capital deployed</div>
                            </div>
                            <div className="lg:col-span-1 text-right">
                              <div className="text-slate-700 dark:text-slate-300 text-lg font-bold">$5.79M</div>
                              <div className="text-orange-500 text-sm font-medium">$1.21M at risk</div>
                            </div>
                          </div>
                        </div>

                        {/* Phase 2 */}
                        <div className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-950/30 dark:to-green-950/30 rounded-xl p-6 border border-emerald-200 dark:border-emerald-800 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 items-center">
                            <div className="lg:col-span-1">
                              <div className="inline-flex items-center space-x-2 bg-emerald-700 px-3 py-1 rounded-full">
                                <div className="w-2 h-2 bg-emerald-300 rounded-full animate-pulse"></div>
                                <span className="text-white text-sm font-medium">M12-M14</span>
                              </div>
                            </div>
                            <div className="lg:col-span-2">
                              <h5 className="font-bold text-emerald-900 dark:text-emerald-100 mb-1">First Presales Begin</h5>
                              <p className="text-emerald-700 dark:text-emerald-400 text-sm font-medium">Mazunte revenue incoming</p>
                            </div>
                            <div className="lg:col-span-1 text-center">
                              <div className="text-emerald-600 text-xl font-bold">+$0.257M</div>
                              <div className="text-emerald-500 text-xs">First returns</div>
                            </div>
                            <div className="lg:col-span-1 text-right">
                              <div className="text-slate-700 dark:text-slate-300 text-lg font-bold">$5.78M</div>
                              <div className="text-orange-500 text-sm font-medium">$1.22M at risk</div>
                            </div>
                          </div>
                        </div>

                        {/* Phase 3 */}
                        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-xl p-6 border border-blue-200 dark:border-blue-800 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 items-center">
                            <div className="lg:col-span-1">
                              <div className="inline-flex items-center space-x-2 bg-blue-700 px-3 py-1 rounded-full">
                                <div className="w-2 h-2 bg-blue-300 rounded-full"></div>
                                <span className="text-white text-sm font-medium">M15-M21</span>
                              </div>
                            </div>
                            <div className="lg:col-span-2">
                              <h5 className="font-bold text-blue-900 dark:text-blue-100 mb-1">Brazil Build + Bahia Presales</h5>
                              <p className="text-blue-700 dark:text-blue-400 text-sm">Expansion acceleration</p>
                            </div>
                            <div className="lg:col-span-1 text-center">
                              <div className="text-emerald-600 text-xl font-bold">+$0.442M</div>
                              <div className="text-emerald-500 text-xs">Strong momentum</div>
                            </div>
                            <div className="lg:col-span-1 text-right">
                              <div className="text-slate-700 dark:text-slate-300 text-lg font-bold">$5.39M</div>
                              <div className="text-orange-500 text-sm font-medium">$1.61M at risk</div>
                            </div>
                          </div>
                        </div>

                        {/* Phase 4 */}
                        <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 rounded-xl p-6 border border-purple-200 dark:border-purple-800 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 items-center">
                            <div className="lg:col-span-1">
                              <div className="inline-flex items-center space-x-2 bg-purple-700 px-3 py-1 rounded-full">
                                <div className="w-2 h-2 bg-purple-300 rounded-full"></div>
                                <span className="text-white text-sm font-medium">M21-M30</span>
                              </div>
                            </div>
                            <div className="lg:col-span-2">
                              <h5 className="font-bold text-purple-900 dark:text-purple-100 mb-1">Spain Entry + More Presales</h5>
                              <p className="text-purple-700 dark:text-purple-400 text-sm">European market launch</p>
                            </div>
                            <div className="lg:col-span-1 text-center">
                              <div className="text-emerald-600 text-xl font-bold">+$0.67M</div>
                              <div className="text-emerald-500 text-xs">Peak inflows</div>
                            </div>
                            <div className="lg:col-span-1 text-right">
                              <div className="text-slate-700 dark:text-slate-300 text-lg font-bold">$4.06M</div>
                              <div className="text-amber-500 text-sm font-medium">$2.94M at risk</div>
                            </div>
                          </div>
                        </div>

                        {/* Peak Risk - Dramatic Card */}
                        <div className="relative overflow-hidden bg-gradient-to-br from-red-900 via-red-800 to-red-900 dark:from-red-800 dark:via-red-700 dark:to-red-800 rounded-2xl p-8 border border-red-400/30 shadow-2xl">
                          ...
                          <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
                            <div className="lg:col-span-1">
                              <div className="inline-flex items-center space-x-2 bg-red-600 px-4 py-2 rounded-full">
                                ...
                                <span className="text-white font-bold">M36</span>
                              </div>
                            </div>
                            <div className="lg:col-span-2">
                              <h5 className="text-2xl font-bold text-white mb-2">Peak Capital at Risk</h5>
                              <p className="text-red-200 text-sm">Maximum exposure achieved</p>
                            </div>
                            <div className="lg:col-span-1 text-center">
                              <div className="text-red-300 text-2xl font-bold">-$0.827M</div>
                              <div className="text-red-400 text-xs">Final deployment</div>
                            </div>
                            <div className="lg:col-span-1 text-right">
                              <div className="text-white text-2xl font-bold">$2.94M</div>
                              <div className="text-red-300 text-lg font-bold">$4.06M at risk</div>
                            </div>
                          </div>
                        </div>
                      </div>
