        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Tabs defaultValue="revenue-model" className="w-full">
            ...
            <TabsContent value="revenue-model">
              ...
              <div className="mb-16">
                <div className="text-center mb-12">
                  <h2 className="text-4xl font-bold mb-4">Why $7M Infrastructure Investment</h2>
                  <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Building the foundation for a global digital nomad real estate network
                  </p>
                </div>
                  ...
                  <Card className="bg-card/80 backdrop-blur-sm border-border/50">
                    <CardContent className="p-8">
                      <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Legal & Compliance Foundation</h3>
                        <div className="text-3xl font-bold text-primary">$2.45M</div>
                      </div>
                      <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Securities Compliance</span>
                          <span className="font-semibold">$850K</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Multi-Country Legal Setup</span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Banking Infrastructure</span>
                          <span className="font-semibold">$300K</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Insurance & Risk</span>
                  ...
                  <Card className="bg-card/80 backdrop-blur-sm border-border/50">
                    <CardContent className="p-8">
                      <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Platform Technology</h3>
                        <div className="text-3xl font-bold text-primary">$1.8M</div>
                      </div>
                      <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Smart Contracts & Audits</span>
                          <span className="font-semibold">$520K</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">DeFi Integration</span>
                          <span className="font-semibold">$450K</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Mobile & Web Platform</span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Security & Infrastructure</span>
                          <span className="font-semibold">$170K</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-card/80 backdrop-blur-sm border-border/50">
                    <CardContent className="p-8">
                      <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Market & Operations</h3>
                        <div className="text-3xl font-bold text-primary">$2.75M</div>
                      </div>
                      <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Market Entry & Partnerships</span>
                          <span className="font-semibold">$920K</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Operations & Team</span>
                          <span className="font-semibold">$550K</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Growth & Acquisition</span>
                          <span className="font-semibold">$420K</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Reserve & Contingency</span>
              ...
              <div className="mb-16">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Strategic progression from proof-of-concept to global network state
                  </p>
                </div>
                  ...
                  <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
                    <CardContent className="p-8">
                      <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Phase 1: Proof Engine</h3>
                        <div className="text-lg font-semibold text-muted-foreground">Years 0-3</div>
                      </div>
                      <div className="space-y-4">
                        <div className="bg-background/50 rounded-lg p-4">
                          ...
                          <ul className="text-sm space-y-1 text-muted-foreground">
                            ...
                            <li>• Technology platform launched</li>
                          </ul>
                        </div>
                        <div className="text-center">
                          <div className="text-2xl font-bold text-primary">112 Units</div>
                  ...
                  <Card className="bg-gradient-to-br from-secondary/10 to-secondary/5 border-secondary/20">
                    <CardContent className="p-8">
                      <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Phase 2: Platform Scale</h3>
                        <div className="text-lg font-semibold text-muted-foreground">Years 3-7</div>
                      </div>
                      <div className="space-y-4">
                        <div className="bg-background/50 rounded-lg p-4">
                          <div className="text-sm font-medium mb-2">Key Milestones</div>
                          <ul className="text-sm space-y-1 text-muted-foreground">
                            <li>• Developer onboarding system</li>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-secondary">2,500 Units</div>
                          <div className="text-sm text-muted-foreground">Platform-facilitated development</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-accent/10 to-accent/5 border-accent/20">
                    <CardContent className="p-8">
                      <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Phase 3: Network State</h3>
                        <div className="text-lg font-semibold text-muted-foreground">Years 7-10</div>
                      </div>
                      <div className="space-y-4">
                        <div className="bg-background/50 rounded-lg p-4">
                          <div className="text-sm font-medium mb-2">Key Milestones</div>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-accent">7,500 Units</div>
                          <div className="text-sm text-muted-foreground">Global network state</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
